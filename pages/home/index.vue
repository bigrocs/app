...
<view>
	<view>
		...
		<boxing 
			v-if="branch==='boxing'&&(roles.indexOf('root')>-1||roles.indexOf('manager')>-1||roles.indexOf('director')>-1)"
		/>
		<chunliang 
			v-if="branch==='chunliang'&&(roles.indexOf('root')>-1||roles.indexOf('manager')>-1||roles.indexOf('director')>-1)"
		/>
		<view v-if="!(roles.indexOf('root')>-1||roles.indexOf('manager')>-1||roles.indexOf('director')>-1)"  class="content">
